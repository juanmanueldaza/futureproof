"""Tool call repair middleware — detects and repairs orphaned tool_calls.

When parallel tool execution fails to merge results back into the messages
channel, this middleware injects synthetic error ToolMessages so the model
can proceed instead of crashing.

Usage:
    from fu7ur3pr00f.agents.middleware.tool_call_repair import (
...
__all__ = ["ToolCallRepairMiddleware"]
