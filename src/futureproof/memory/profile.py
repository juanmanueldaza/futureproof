...
def update_profile_field(field_path: str, value: Any) -> UserProfile:
    """Update a specific field in the profile.

    Args:
        field_path: Dot-separated path like "skills.technical" or "career.target_roles"
    ...
    field_mapping = {
        ...
        "skills.technical": "technical_skills",
        "skills.soft": "soft_skills",
        "career.target_roles": "target_roles",
        "career.deal_breakers": "deal_breakers",
        "preferences.work_style": "preferred_work_style",
    }

    attr_name = field_mapping.get(field_path, field_path)
